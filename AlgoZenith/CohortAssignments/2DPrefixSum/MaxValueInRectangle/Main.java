...
static long[][] build2dPrefixSum(long[][] mat, int n , int m) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(int i = 0 ; i < q ; i++ ) {
            ...
            mat[x1][y1] += c ;
            if(y2 + 1 <= m) mat[x1][y2 + 1] -= c ;
            if(x2 + 1 <= n) mat[x2 + 1][y1] -= c ;
            if(x2 + 1 <= n && y2 + 1 <= m ) mat[x2+1][y2+1] += c ;
        ...
        out.append(currentMax).append(" ").append(map.get(currentMax)) ;
