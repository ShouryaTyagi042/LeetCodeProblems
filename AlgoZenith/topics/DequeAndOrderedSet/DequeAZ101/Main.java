    ...
    public static void main(String[] args) throws Exception {
        ...
        while (t-- > 0) {
            ...
            for(int i = 0 ; i < q ; i++) {
                ...
                if(query.equals("insertback")) {
                    int val = fs.nextInt() ;
                    deque.addLast(val) ;
                }

                else if(query.equals("insertfront")) {
                    int val = fs.nextInt() ;
                    deque.addFirst(val) ;
                }

                else if(query.equals("eraseback")) {
                    if(!deque.isEmpty()) {
                        deque.removeLast() ;
                    }
                }

               else if(query.equals("erasefront")) {
                    if(!deque.isEmpty()) {
                        deque.removeFirst() ;
                    }
                }
                ...
                if(deque.isEmpty()) {
                    ...
                    out.append(deque.peekFirst()).append('\n') ;
                }
                }

               else if(query.equals("printback")) {
                if(deque.isEmpty()) {
                    out.append(0).append('\n') ;
                } else {
